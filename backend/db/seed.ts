...
const seedUsers = [
  ...
  { id: 'usr-seller-1', name: 'Mesfin Tadese', email: 'mesfin.t@autobroker.et', password_hash: '$2b$10$eBUHz99uAsHqj6Va7U00x.A9HJGpcmCXtH/gRSCzK4.f.JjaesJ8O', phone: '+251916677788', role: 'seller', verified: true, verification_status: 'verified', join_date: '2025-01-10' }
];
...
const seedVehicles = [
  ...
  { id: 'veh-7', broker_id: 'usr-seller-1', brand: 'Toyota', model: 'Camry', year: 2022, mileage: 18000, price: 5500000.00, original_price: 6000000.00, status: 'approved', image_url: 'https://images.unsplash.com/photo-1621007947382-bb3c3994e3fb?auto=format&fit=crop&w=800&q=80', description: 'Well maintained Camry, single owner, full service history.', fuel_type: 'Benzine', transmission: 'Automatic', location: 'Addis Ababa', condition: 'Used', body_type: 'Sedan', drive_type: 'FWD', color: 'Silver', doors: 4, seats: 5, engine_size: '2.5L', engine_type: 'V4', horsepower: 203, commission_rate: 0, commission_type: 'percentage', inspection_status: 'not_inspected' },
];
...
const seedLeads = [
  ...
  { id: 'ld-4', vehicle_id: 'veh-7', buyer_id: null, buyer_name: 'Hanna Wondimu', buyer_email: 'hanna.w@gmail.com', buyer_phone: '+251917778899', message: 'Hello, is the Camry still available? I would like to view it this weekend.', inquiry_date: new Date().toISOString(), status: 'new' },
];
